      ...
      tabsetPanel(
        ...
        tabPanel("Top-5 hits",
                 ...
                 tags$ul(
                   ...
                   tags$li(strong("Deviation_from_mean:"), "How many standard deviations apart is the reference score sum from the average score for that cluster (see How-to tab for details)"),
                   tags$li(strong("Long_name:"), "Frequency of genes that exhibit positive correlation between the unknown cluster and a given reference cell type (see How-to tab for details)")
                 )
                 )
        ),
        ...
        tabPanel("How to use this program",
                 ...
                 tags$ul(
                   tags$li(strong("Incorrectly naming the columns."), "Our algorithm should be agnostic to capitalization, but the column names should include", strong(em("Gene, Cluster, and logFC.")), "The data frame generated by Seurat's FindAllMarkers() function is can work directly in our algorithm."),
